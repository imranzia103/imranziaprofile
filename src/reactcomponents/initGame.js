...
import { PALLETTE } from "./constants.js";
import makeSocialIcon from "../components/SocialIcon.js";
import makeSkillIcon from "../components/SkillIcon.js";
import { makeAppear } from "./utils";
import makeWorkExperienceCard from "../components/WorkExperienceCard.js";
import makeEmailIcon from "../components/EmailIcon.js";
import makeProjectCard from "../components/ProjectCard.js";
import { cameraZoomValueAtom, store } from "./store.js";
...
export default async function initGame() {
  ...
  const tiledBackground = k.add([
    ...
    k.shader("tiledPattern", () => ({
      u_time: k.time() / 20,
      u_color1: k.Color.fromHex(PALLETTE.color3),
      u_color2: k.Color.fromHex(PALLETTE.color2),
      u_speed: k.vec2(1, -1),
